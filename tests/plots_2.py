...
EXPS_PATHS = [
    '/home/pedro/git/DECAF/tests/exp_data/MAIN_door_env_2021-12-26-21-50-10/train_data.json',
    '/home/pedro/git/DECAF/tests/exp_data/MAIN_door_env_2021-12-26-20-44-06/train_data.json',
]

DEFAULT_EXP_PATH = '/home/pedro/git/DECAF/tests/exp_data/MAIN_door_env_2021-12-27-05-18-01/train_data.json'
...
if __name__ == "__main__":
    ...
    width = 0.353
    rects1 = plt.bar(X - width/2, Ys_a0_mean, width)#, yerr=cis_false, label='Cov=False')
    rects2 = plt.bar(X + width/2, Ys_a1_mean, width)#, yerr=cis_true, label='Cov=True')

    plt.xticks(X, labels=['E[D|b]', 'E[D|do(b)](Back-door)', 'E[D|do(b)](Our)'])
